...
const OptionButton = (props) => {
    const letters =['A','B','C'];
  return (
    <button className={`h-8 ${props.onMobile? 'w-[238px]':'w-[287px]'} transition-all bg-black/50 rounded-md border-2 border-white/80 flex flex-row items-center p-2 gap-2 mb-1`}
    onClick={()=>{
      if(props.external)
      {
