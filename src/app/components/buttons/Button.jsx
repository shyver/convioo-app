...
const Button = (props) => {
  return (
    <button className={`${props.width} ${ props.height ? props.height : 'h-10'} ${ props.padding ? props.padding : 'px-4 py-2'} ${props.backgroundColor} rounded justify-center items-center gap-2 inline-flex ${props.border ? 'border' : ''} ${props.borderColor}`} onClick={props.onClick}>
