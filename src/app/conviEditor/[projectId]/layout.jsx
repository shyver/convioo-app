...
const Layout = ({params}) => {
  ...
  return (
    ...
    <div className='h-[56px] bg-white flex items-center flex-row justify-between px-2'>
    ...
    <div className='flex flex-row gap-2'>
      ...
      <Button LeftIcon={arrow} title='Preview' border={true} borderColor='border-[#A6A6A6] '/>
